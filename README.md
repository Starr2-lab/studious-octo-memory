...
This folder contains a minimal Vite configuration and placeholder frontend entry files used
by the Laravel app. The README documents how to run the frontend build and development
workflow locally on Windows (PowerShell).
